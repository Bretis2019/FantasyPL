        ...
        <div key={item.id}  className={"bg-gray-400 Card text-black rounded-xl border-2 border-black px-4 py-2 max-w-[90svw] md:max-w-[450px] flex flex-col gap-y-3"}>
            ...
            <div className={"flex justify-between w-full"}>
                <div className={"flex gap-x-2 items-center"}>
                    <div onClick={() => setPick(item.home_team)} className={`cursor-pointer rounded-full p-4 ${pick === item.home_team ? "bg-green-600" : "bg-white"} border-2 border-black`}></div>
                ...
                <div className={"flex gap-x-2 items-center"}>
                    ...
                    <div onClick={() => setPick(item.away_team)} className={`cursor-pointer rounded-full p-4 ${pick === item.away_team ? "bg-green-600" : "bg-white"} border-2 border-black`}></div>
                </div>
            </div>
