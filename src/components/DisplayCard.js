...
export default function DisplayCard( props){
    ...
    return (
        <div key={item.id}  className={"bg-gray-400 Card text-black rounded-xl border-2 border-black px-4 py-2 w-[90svw] md:max-w-[450px] flex flex-col gap-y-3"}>
            ...
            <div className={"flex justify-between w-full"}>
                ...
                <div className={"flex flex-col-reverse md:flex-row gap-x-2 items-center"}>
